...
```bash
# Create chore
curl -X POST https://yourapp.com/api/v1/chores \
...
```bash
# Create prize
curl -X POST https://yourapp.com/api/v1/prizes \
  -H "Authorization: Bearer choreo_xyzabc..." \
  -H "Content-Type: application/json" \
  -d '{
    "name": "Movie Night",
...
# Create redemption
curl -X POST https://yourapp.com/api/v1/redemptions \
  -H "Authorization: Bearer choreo_xyzabc..." \
  -H "Content-Type: application/json" \
  -d '{
    "memberId": "user123",
...
curl -X PUT "https://yourapp.com/api/v1/redemptions?id=redemption789" \
  -H "Authorization: Bearer choreo_xyzabc..." \
  -H "Content-Type: application/json" \
  -d '{"status": "fulfilled"}'
```
...
```bash
curl https://yourapp.com/api/v1/activity?limit=20 \
  -H "Authorization: Bearer choreo_xyzabc..."
